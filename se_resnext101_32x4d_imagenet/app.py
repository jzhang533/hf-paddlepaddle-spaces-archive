...
description="Squeeze-and-Excitation Networks is an image classification structure proposed by Momenta in 2017. This structure improves the accuracy by modeling the correlation between feature channels and strengthening important features. SE_ResNeXt adds SE Block based on the ResNeXt model and won the 2017 ILSVR competition. The structure of the PaddleHub Module is SE_ResNeXt101_32x4d. It is trained based on the ImageNet-2012 dataset. The input image size is 224 x 224 x 3. It supports prediction directly through the command line or Python interface."
